...
Rta: el LATE se obtiene dividiendo el ITT por la tasa de cumplimiento.Se observa que los valores de LATE calculados manualmente son muy similares a los estimados mediante el método de variables instrumentales. Pero existen diferencias (4% al 11%) y se puede explicar como la forma en la que se calcula manual no se tiene en cuenta errores estándar, covarianzas etc. Finalmente, la relación matemática entre ITT, tasa de cumplimiento y LATE se cumple en la práctica y que la estrategia de identificación empleada resulta consistente para estimar el efecto local del microcrédito sobre los hogares que cumplen con la asignación.
